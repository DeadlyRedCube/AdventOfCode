...
export inline void SaveWicTexture(const wchar_t *path, u32 width, u32 height, ArrayView<u32> argbColors)
{
  ...
  frameEncode->WritePixels(
    ...
    const_cast<u8 *>(reinterpret_cast<const u8*>(swizzledColors.Elements())));
